...
init_image"S00000.JPG"
secon_image="S00001.JPG"
...
&& openMVG_main_ComputeFeatures -i ${matches}sfm_data.json -o $matches -m AKAZE_FLOAT -p NORMAL \
...
&& openMVG_main_IncrementalSfM -i ${matches}sfm_data.json -m $matches -o $reconstruct_dir -a ${init_image} -b ${secon_image}